...
socket.on('join_room_response', (payload) =>{
    ...
    let nodeB = $("<div></div>");
    nodeB.addClass("col");
    nodeB.addClass("align-item-center");
...
socket.on('game_update', (payload) =>{
    ...
    if( my_color ==='white'){
        $("#my_color").html('<h3 style="color:white";id="my_color">I am white</h3>');
    }
    else if( my_color ==='black'){
        $("#my_color").html('<h3 style="color:black"; id="my_color">I am black</h3>');
    }
    else{
    ...
    if( payload.game.whose_turn ==='white'){
        $("#my_color").append('<h4 style="color:white">It is white\'s turn</h4>');
    }
    else if( payload.game.whose_turn ==='black'){
        $("#my_color").append('<h4 style="color:black">It is black\'s turn</h4>');
    }
    else{
        ...
        for (let column = 0; column < 8; column++) {
            ...
            if(old_board[row][column] !== board[row][column]) {
                ...
                if((old_board[row][column] === '?') && (board[row][column] === ' ')) {
                    ...
                    graphic = "Empty-White-tocken.gif";
                    altTag = "white tocken";
                }
                else if((old_board[row][column] === '?') && (board[row][column] === 'b')) {
                    graphic = "Empty-Black-tocken.gif";
                    altTag = "black tocken";
                }
                else if((old_board[row][column] === ' ') && (board[row][column] === 'w')) {
                    graphic = "Empty-White-tocken.gif";
                    ...
                    graphic = "White-Empty-tocken.gif";
                    altTag = "empty space";
                }
                else if((old_board[row][column] === 'b') && (board[row][column] === ' ')) {
                    graphic = "Black-Empty-tocken.gif";
                    altTag = "empty space";
                }
                else if((old_board[row][column] === 'w') && (board[row][column] === 'b')) {
                    graphic = "White-Black-tocken.gif";
                    altTag = "black token";
                }
                else if((old_board[row][column] === 'b') && (board[row][column] === 'w')) {
                    graphic = "Black-White-tocken.gif";
                    altTag = "white token";
                }
                else {
                    graphic = "Error.gif";
